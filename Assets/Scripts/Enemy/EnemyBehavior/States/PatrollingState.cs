...
public class PatrollingState : BaseState<PatrolEnemyBehavoir>
{
    public PatrollingState(PatrolEnemyBehavoir key, StateManager<PatrolEnemyBehavoir> manager, EnemyStats stats, GameObject enemy, MonoBehaviour monoBehavior, LayerMask spellLayer) : base(key, manager)
    {
        _stats = stats;
        _enemy = enemy;
        _manager = manager;
    ...
    public override void OnTriggerEnter(Collider other)
    {
        ...
        {
            _manager.TransitionToState(PatrolEnemyBehavoir.PatrolRunning);
        }
    }
