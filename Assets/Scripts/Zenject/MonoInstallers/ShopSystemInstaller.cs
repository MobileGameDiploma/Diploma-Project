...
public class ShopSystemInstaller : MonoInstaller
{
    ...
    public List<int> SpeedUpgrades;
    public List<int> CastUpgrades;
    [Header("Prices")]
    ...
    public override void InstallBindings()
    {
        ...
        Container.Bind<List<int>>().WithId("SpeedUpgrades").FromInstance(SpeedUpgrades).AsCached();
        Container.Bind<List<int>>().WithId("CastUpgrades").FromInstance(CastUpgrades).AsCached();
